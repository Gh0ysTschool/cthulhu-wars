<script lang="javascript">
    ...
    let places = {arcticocean, northpacific, northamerica, northatlantic, scandinavia, europe, northasia, southamerica, southasia, arabia, westafrica, indianocean, eastafrica, antarctica, southatlantic, southpacific, australia}
    for (let key of Object.keys(places)){
        places[key] = {name:key,gate:0}
    }
</script>
<style lang="stylus">
    arcticocean = #c4b29B
